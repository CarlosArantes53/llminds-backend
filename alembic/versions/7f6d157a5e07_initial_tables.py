...
Revision ID: 7f6d157a5e07
Revises: 
Create Date: 2026-02-17 00:00:52.440290
"""
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_ticket_replies_author_id'), 'ticket_replies', ['author_id'], unique=False)
    op.create_index(op.f('ix_ticket_replies_created_at'), 'ticket_replies', ['created_at'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_ticket_replies_created_at'), table_name='ticket_replies')
    op.drop_index(op.f('ix_ticket_replies_author_id'), table_name='ticket_replies')
